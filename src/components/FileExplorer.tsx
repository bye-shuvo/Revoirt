...
import { executeIDB } from "./utils/useIndexedDB.ts";
...
const FileExplorer = () => {
  ...
  const [file, setFile] = useState<file | null>(null); //put new file
