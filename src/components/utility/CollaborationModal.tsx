...
const CollaborationModal = () => {
  ...
  return (
    <div ref={islandRef} className="absolute left-1/2 right-1/2 -translate-x-1/2 -translate-y-1/3 bg-mist-700 h-[70%] w-[40%] z-100 p-10 text-white flex flex-col items-center border border-gray-400">
