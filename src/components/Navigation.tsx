const Navigation = () => {
  return (
    <nav className="bg-mist-900 h-[6%] w-full flex justify-between items-center px-3">
      <h1 className='font-saira-stencil-one text-2xl text-white' title="Code together , Build Fast">REVOIRT</h1>
      <div></div>
